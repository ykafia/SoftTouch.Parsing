        ...
        where TScanner : struct, IScanner
    {
        ...
        if (ExpressionParser.Or(ref scanner, result, out parsed))
        {
            ...
            if (Terminals.Char('?', ref scanner, advance: true))
            {
                ...
                CommonParsers.Spaces0(ref scanner, result, out _);
                if (ExpressionParser.Expression(ref scanner, result, out var left, new("Expected expression", scanner.CreateError(scanner.Position))))
                {
                    CommonParsers.Spaces0(ref scanner, result, out _);
                    if (Terminals.Char(':', ref scanner, advance: true))
                    {
                        CommonParsers.Spaces0(ref scanner, result, out _);
                        if (ExpressionParser.Expression(ref scanner, result, out var right, new("Expected expression", scanner.CreateError(scanner.Position))))
                        {
        ...
        where TScanner : struct, IScanner
    {
        ...
        do
        {
            ...
            if (op != "" && parsed is not null)
            {
                ...
                else return CommonParsers.Exit(ref scanner, result, out parsed, position, new("Expecting AndExpression", scanner.CreateError(scanner.Position)));
            }
        ...
        where TScanner : struct, IScanner
    {
        ...
        do
        {
            ...
            if (op != "" && parsed is not null)
            {
                ...
                else return CommonParsers.Exit(ref scanner, result, out parsed, position, new("Expecting BitwiseOrExpression", scanner.CreateError(scanner.Position)));
            }
            else if (parsed is null && op == "")
            {
                if (ExpressionParser.BOr(ref scanner, result, out var bOr))
        ...
        where TScanner : struct, IScanner
    {
        ...
        do
        {
            ...
            if (op != "" && parsed is not null)
            {
                ...
                else return CommonParsers.Exit(ref scanner, result, out parsed, position, new("Expecting XorExpression", scanner.CreateError(scanner.Position)));
            }
            else if (parsed is null && op == "")
            {
                if (ExpressionParser.XOr(ref scanner, result, out var xor))
        ...
        where TScanner : struct, IScanner
    {
        ...
        do
        {
            ...
            if (op != "" && parsed is not null)
            {
                ...
                else return CommonParsers.Exit(ref scanner, result, out parsed, position, new("Expecting BitwiseAndExpression", scanner.CreateError(scanner.Position)));
            }
            else if (parsed is null && op == "")
            {
                if (ExpressionParser.BAnd(ref scanner, result, out var bAnd))
        ...
        where TScanner : struct, IScanner
    {
        ...
        do
        {
            ...
            if (op != "" && parsed is not null)
            {
                ...
                else return CommonParsers.Exit(ref scanner, result, out parsed, position, new("Expecting EqualityExpression", scanner.CreateError(scanner.Position)));
            }
            else if (parsed is null && op == "")
            {
                if (ExpressionParser.Equality(ref scanner, result, out var eq))
        ...
        where TScanner : struct, IScanner
    {
        ...
        do
        {
            ...
            if (op != "" && parsed is not null)
            {
                ...
                else return CommonParsers.Exit(ref scanner, result, out parsed, position, new("Expecting RelationExpression", scanner.CreateError(scanner.Position)));
            }
            else if (parsed is null && op == "")
            {
                if (ExpressionParser.Relation(ref scanner, result, out var rel))
        ...
        where TScanner : struct, IScanner
    {
        ...
        do
        {
            ...
            if (op != "" && parsed is not null)
            {
                ...
                else return CommonParsers.Exit(ref scanner, result, out parsed, position, new("Expecting ShiftExpression", scanner.CreateError(scanner.Position)));
            }
            else if (parsed is null && op == "")
            {
                if (ExpressionParser.Shift(ref scanner, result, out var shift))
        ...
        while (!Terminals.AnyOf(["<=", ">="], ref scanner, out _) && Terminals.AnyOf([">", "<"], ref scanner, out op, advance: true));
        if (parsed is not null)
            return true;
        else return CommonParsers.Exit(ref scanner, result, out parsed, position, orError);
    }
        ...
        where TScanner : struct, IScanner
    {
        ...
        do
        {
            ...
            if (op != "" && parsed is not null)
            {
                ...
                else return CommonParsers.Exit(ref scanner, result, out parsed, position, new("Expecting AddExpression", scanner.CreateError(scanner.Position)));
            }
            else if (parsed is null && op == "")
            {
                if (ExpressionParser.Add(ref scanner, result, out var add))
